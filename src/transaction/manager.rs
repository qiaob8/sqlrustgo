...
mod tests {
    ...
    fn test_transaction_begin() {
        let path = std::env::temp_dir().join("tm_test_begin.log");
        let path_str = path.to_str().unwrap();
        std::fs::remove_file(path_str).ok();

        let wal = Arc::new(WriteAheadLog::new(path_str).unwrap());
    ...
    fn test_transaction_commit() {
        let path = std::env::temp_dir().join("tm_test_commit.log");
        let path_str = path.to_str().unwrap();
        std::fs::remove_file(path_str).ok();
    ...
    fn test_transaction_rollback() {
        let path = std::env::temp_dir().join("tm_test_rollback.log");
        let path_str = path.to_str().unwrap();
        std::fs::remove_file(path_str).ok();
    ...
    fn test_transaction_get_state() {
        let path = std::env::temp_dir().join("tm_test_state.log");
        let path_str = path.to_str().unwrap();
        std::fs::remove_file(path_str).ok();
    ...
    fn test_transaction_nonexistent() {
        let path = std::env::temp_dir().join("tm_test_nonexistent.log");
        let path_str = path.to_str().unwrap();
        std::fs::remove_file(path_str).ok();
    ...
    fn test_transaction_commit_nonexistent() {
        let path = std::env::temp_dir().join("tm_test_commit_nonexistent.log");
        let path_str = path.to_str().unwrap();
        std::fs::remove_file(path_str).ok();
    ...
    fn test_transaction_rollback_nonexistent() {
        let path = std::env::temp_dir().join("tm_test_rollback_nonexistent.log");
        let path_str = path.to_str().unwrap();
        std::fs::remove_file(path_str).ok();
    ...
    fn test_transaction_double_commit() {
        let path = std::env::temp_dir().join("tm_test_double_commit.log");
        let path_str = path.to_str().unwrap();
        std::fs::remove_file(path_str).ok();
    ...
    fn test_transaction_double_rollback() {
        let path = std::env::temp_dir().join("tm_test_double_rollback.log");
        let path_str = path.to_str().unwrap();
        std::fs::remove_file(path_str).ok();
    ...
    fn test_transaction_commit_after_rollback() {
        let path = std::env::temp_dir().join("tm_test_commit_after_rollback.log");
        let path_str = path.to_str().unwrap();
        std::fs::remove_file(path_str).ok();
    ...
    fn test_transaction_multiple_concurrent() {
        let path = std::env::temp_dir().join("tm_test_concurrent.log");
        let path_str = path.to_str().unwrap();
        std::fs::remove_file(path_str).ok();
    ...
    fn test_transaction_snapshot() {
        let path = std::env::temp_dir().join("tm_test_snapshot.log");
        let path_str = path.to_str().unwrap();
        std::fs::remove_file(path_str).ok();
